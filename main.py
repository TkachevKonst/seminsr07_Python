...
# def rhyme (list_1, dict_1):
#     count_1 = set([sum(1 for j in i if j in dict_1) for i in list_1 ])
#     print(count_1)
#     if len(count_1) == 1:
...
#
#
# a = ('пара-ра-рам рам-пам-папам па-ра-дапа')
# list_1 = a.lower().split(' ')
# dict_1 = ('а', 'у', 'е', 'ы', 'о', 'э', 'я','и', 'ю', 'ё')
# print(rhyme(list_1, dict_1))
